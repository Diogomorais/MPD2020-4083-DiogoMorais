...
public class WeatherRestful implements  WeatherApi  {
    ...
    /**
     * E.g. http://api.worldweatheronline.com/premium/v1/past-weather.ashx?q=37.017,-7.933&date=2019-01-01&enddate=2019-01-30&tp=24&format=csv&key=13743045f978438ba91233229202003
     *
    ...
    public Iterable<WeatherInfo> pastWeather(double lat, double log, LocalDate from, LocalDate to) {
        ...
        return map(asList(dto.getData().getWeather()), WeatherRestful::toPastWeather);
    }
    ...
    /**
     * e.g. http://api.worldweatheronline.com/premium/v1/search.ashx?query=Oporto&format=tab&key=13743045f978438ba91233229202003
     *
